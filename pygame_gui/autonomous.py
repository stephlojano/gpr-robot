...
single_rotation_speed = (
    1 / rpm
) * 60  # This gives the time it takes for the wheel to make a single rotation in seconds
...
robot_speed = (
    wheel_circumference / single_rotation_speed
)  # gives robot speed in meters per second -> approximately 0.9423 m/s
